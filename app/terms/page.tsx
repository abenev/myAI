    ...
    <div className="w-full flex justify-center p-10">
      <div className="w-full max-w-screen-md space-y-6">
        ...
        <h2 className="text-2xl font-semibold">
          Terms of Use and Disclaimer for FinWise
        </h2>
        <ol className="list-decimal list-inside space-y-4">
          <li className="text-gray-700">
            <span className="font-semibold">Acceptance of Terms:</span> By
            accessing and using the AI chatbot ("FinWise") provided by Arina,
          ...
          <li className="text-gray-700">
            ...
            or implied. Arina makes no representations or warranties regarding
          ...
          <li className="text-gray-700">
            ...
            Arina does not guarantee that the Chatbot will be available at all
          ...
          <li className="text-gray-700">
            ...
            the fullest extent permitted by applicable law, Arina shall not be
            ...
            Arina has been advised of the possibility of such damages.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">
          ...
          <li className="text-gray-700">
            ...
            decisions made based on its output. Arina is not responsible for any
          ...
          <li className="text-gray-700">
            ...
            considered equivalent to public postings, and Arina does not
          ...
          <li className="text-gray-700">
            ...
            indemnify, defend, and hold harmless Arina from any claims,
            liabilities, damages, losses, and expenses, including reasonable
            legal fees, arising from your use of the Chatbot or violation of
            these Terms of Use.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">Modifications to Terms:</span> Arina
          ...
          <li className="text-gray-700">
            ...
            contact Arina at abenev@unc.edu.
          </li>
        </ol>
      </div>
    </div>
